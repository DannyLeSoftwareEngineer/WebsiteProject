<?php session_start(); require_once('tools.php'); start("Home Page"); ?>
...
<body onload="showSlides()">
    ...
    <main>
        <h1>ABOUT ROOSTER TEETH</h1>

        <div class="autoslideshow-container">
            <div class="founders">

                <div class="mySlides fade">
                    <img src='../../media/RoosterTeethFounders.jpeg' alt="RoosterTeethFounders" class="singleslide">
                    <div class="container">
                        <p>Rooster Teeth Founders
                            <br>From left to right: Burnie Burns, Geoff Ramsey, Matt Hullum and Gus Sorola.</p>
                    </div>
                </div>

                <div class="mySlides fade">
                    <img src='../../media/RedvsBlue.jpg' alt="Red vs Blue" class="singleslide">
                    <div class="container">
                        <p>April 1, 2003 - Red vs Blue is released and Roosterteeth was founded</p>
                    </div>
                </div>

                <div class="mySlides fade">
                    <img src='../../media/RT Shorts.jpg' alt="RT Shorts" class="singleslide">
                    <div class="container">
                        <p>December 3, 2004 - Premiere of RT Shorts</p>
                    </div>
                </div>

                <div class="mySlides fade">
                    <img src='../../media/RT Panics.png' alt="RT Panics" class="singleslide">
                    <div class="container">
                        <p>September 30, 2005 - Series premiere of PANICS</p>
                    </div>
                </div>

                <div class="mySlides fade">
                    <img src='../../media/RT AH.png' alt="RT AH" class="singleslide">
                    <div class="container">
                        <p>July 6, 2008 - Achievement Hunter founded by Geoff and Jack</p>
                    </div>
                </div>

                <div class="mySlides fade">
                    <img src='../../media/RT RTX.jpg' alt="RT RTX" class="singleslide">
                    <div class="container">
                        <p>May 27, 2011 - First RTX in Austin, TX with 400 attendees</p>
                    </div>
                </div>

                <div class="mySlides fade">
                    <img src='../../media/RT RWBY.png' alt="RT RWBY" class="singleslide">
                    <div class="container">
                        <p>July 2013 - First episode of RWBY is released at RTX</p>
                    </div>
                </div>

                <div class="mySlides fade">
                    <img src='../../media/RT Lazer Team.jpg' alt="RT LAZER TEAM" class="singleslide">
                    <div class="container">
                        <p>January 27, 2016 - Release of Lazer Team</p>
                    </div>
                </div>

                <div class="mySlides fade">
                    <img src='../../media/RT CAMP CAMP.jpg' alt="RT CAMP CAMP" class="singleslide">
                    <div class="container">
                        <p>June 17, 2016 - First episode of Camp Camp is released</p>
                    </div>
                </div>

                <div class="mySlides fade">
                    <img src='../../media/RT 15 Years.jpg' alt="RT 15 Years" class="singleslide">
                    <div class="container">
                        <p>April 1, 2018 - 15 Year Anniversary of Rooster Teeth</p>
                    </div>
                </div>
